        ...
        <InsertItemTemplate>
            <div class="gap-4 p-6 grid grid-cols-1 rounded border-2 border-[#6B1F29]">
                ...
                <div class="space-y-2">
                    <label class="text-gray-700 block text-sm font-medium">
                        Start Date:</label>
                    <asp:TextBox ID="TASK_START_DATETextBox" runat="server" TextMode="Date" Text='<%# Bind("TASK_START_DATE", "{0:yyyy-MM-dd}") %>' 
                ...
                <div class="space-y-2">
                    <label class="text-gray-700 block text-sm font-medium">
                        Due Date:</label>
                    <asp:TextBox ID="TASK_DUE_DATETextBox" runat="server" TextMode="Date" Text='<%# Bind("TASK_DUE_DATE", "{0:yyyy-MM-dd}") %>' 
                        CssClass="w-full rounded py-1 px-2 border border-gray-500 shadow-sm focus:border-[#B54555] focus:ring-[#B54555]" 
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="TASK_ID" DataSourceID="SqlDataSource1" CssClass="divide-gray-200 min-w-full divide-y text-center"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Start Date" SortExpression="TASK_START_DATE" ItemStyle-CssClass="px-6 py-4 max-w-max truncate">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBoxStartDate" runat="server" TextMode="Date" Text='<%# Bind("TASK_START_DATE", "{0:yyyy-MM-dd}") %>' 
                            CssClass="w-full rounded py-1 px-2 border border-gray-500 shadow-sm focus:border-[#B54555] focus:ring-[#B54555]" 
                            min='<%# DateTime.Today.ToString("yyyy-MM-dd") %>'/>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Due Date" SortExpression="TASK_DUE_DATE" ItemStyle-CssClass="px-6 py-4 max-w-max truncate">
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBoxDueDate" runat="server" TextMode="Date" Text='<%# Bind("TASK_DUE_DATE", "{0:yyyy-MM-dd}") %>' 
                            CssClass="w-full rounded py-1 px-2 border border-gray-500 shadow-sm focus:border-[#B54555] focus:ring-[#B54555]" 
                            min='<%# DateTime.Today.AddDays(1).ToString("yyyy-MM-dd") %>'/>
                    </EditItemTemplate>
                </asp:TemplateField>
