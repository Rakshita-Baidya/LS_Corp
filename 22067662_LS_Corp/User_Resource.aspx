...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="mb-8 text-4xl font-bold text-[#6B1F29]">Assigned Resource Management</h2>

    <asp:FormView ID="FormView1" runat="server" DataKeyNames="USER_TASK_RESOURCE_ID" DataSourceID="SqlDataSource1" CssClass="mb-8 w-1/2">
        <InsertItemTemplate>
    ...
    <div class="p-6 mb-8 rounded-lg border-2 border-[#6B1F29] shadow-lg">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="USER_TASK_RESOURCE_ID" DataSourceID="SqlDataSource1" CssClass="divide-gray-200 min-w-full divide-y truncate text-center"
            ...
            <Columns>
                <asp:BoundField DataField="USER_TASK_RESOURCE_ID" HeaderText="ID" ReadOnly="True" SortExpression="USER_TASK_RESOURCE_ID" ItemStyle-CssClass="px-6 py-4" />
                ...
                <asp:TemplateField HeaderText="Task Name" ItemStyle-CssClass="px-6 py-4">
                    <ItemTemplate>
                        <asp:DropDownList ID="DropDownListTaskName" runat="server" DataSourceID="SqlDataSource3" DataTextField="TASK_NAME" DataValueField="TASK_ID" SelectedValue='<%# Eval("TASK_ID") %>' Enabled="False" CssClass="w-full py-1 px-2 text-black bg-transparent border-none appearance-none text-center" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Resource ID" SortExpression="RESOURCE_ID" ItemStyle-CssClass="px-6 py-4">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Resource Name" ItemStyle-CssClass="px-6 py-4">
                    <ItemTemplate>
                        <asp:DropDownList ID="DropDownListResourceName" runat="server" DataSourceID="SqlDataSource4" DataTextField="RESOURCE_NAME" DataValueField="RESOURCE_ID" SelectedValue='<%# Eval("RESOURCE_ID") %>' Enabled="False" CssClass="w-full py-1 px-2 text-black bg-transparent border-none appearance-none  text-center" />
                    </ItemTemplate>
                </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;USER_TASK_RESOURCE&quot; WHERE &quot;USER_TASK_RESOURCE_ID&quot; = :USER_TASK_RESOURCE_ID" InsertCommand="INSERT INTO &quot;USER_TASK_RESOURCE&quot; (&quot;USER_TASK_RESOURCE_ID&quot;, &quot;USER_ID&quot;, &quot;TASK_ID&quot;, &quot;RESOURCE_ID&quot;) VALUES (:USER_TASK_RESOURCE_ID, :USER_ID, :TASK_ID, :RESOURCE_ID)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;USER_TASK_RESOURCE_ID&quot;, &quot;USER_ID&quot;, &quot;TASK_ID&quot;, &quot;RESOURCE_ID&quot; FROM &quot;USER_TASK_RESOURCE&quot; ORDER BY &quot;USER_TASK_RESOURCE_ID&quot;" UpdateCommand="UPDATE &quot;USER_TASK_RESOURCE&quot; SET &quot;USER_ID&quot; = :USER_ID, &quot;TASK_ID&quot; = :TASK_ID, &quot;RESOURCE_ID&quot; = :RESOURCE_ID WHERE &quot;USER_TASK_RESOURCE_ID&quot; = :USER_TASK_RESOURCE_ID">
        <DeleteParameters>
            <asp:Parameter Name="USER_TASK_RESOURCE_ID" Type="Decimal" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="USER_TASK_RESOURCE_ID" Type="Decimal" />
