...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="USER_PROJECT_TASK_ID" DataSourceID="SqlDataSource1">
            <Columns>
