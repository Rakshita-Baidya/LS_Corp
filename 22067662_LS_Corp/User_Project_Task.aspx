<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="User_Project_Task.aspx.cs" Inherits="_22067662_LS_Corp.User_Project_Task" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>User Project Title</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="USER_PROJECT_TASK_ID" DataSourceID="SqlDataSource1">
            <Columns>
                <asp:CommandField ShowDeleteButton="True" ShowEditButton="True" />
                <asp:BoundField DataField="USER_PROJECT_TASK_ID" HeaderText="USER_PROJECT_TASK_ID" ReadOnly="True" SortExpression="USER_PROJECT_TASK_ID" />
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="USER_PROJECT_TASK_ID" DataSourceID="SqlDataSource1" OnPageIndexChanging="FormView1_PageIndexChanging">
            
            <InsertItemTemplate>
                USER_PROJECT_TASK_ID:
                <asp:TextBox ID="USER_PROJECT_TASK_IDTextBox" runat="server" Text='<%# Bind("USER_PROJECT_TASK_ID") %>' />
                <br />
                TASK_ID:
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource4" DataTextField="TASK_NAME" DataValueField="TASK_ID" SelectedValue='<%# Bind("TASK_ID") %>'>
                </asp:DropDownList>
                <br />
                USER_ID:
                ...
                <br />
                PROJECT_ID:
                <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource3" DataTextField="PROJECT_NAME" DataValueField="PROJECT_ID" SelectedValue='<%# Bind("PROJECT_ID") %>'>
                </asp:DropDownList>
                <br />
