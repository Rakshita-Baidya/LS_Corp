...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="COMMENT_ID" DataSourceID="SqlDataSource1">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;COMMENTS&quot; WHERE &quot;COMMENT_ID&quot; = :COMMENT_ID" InsertCommand="INSERT INTO &quot;COMMENTS&quot; (&quot;COMMENT_ID&quot;, &quot;COMMENT_MESSAGE&quot;, &quot;TASK_ID&quot;, &quot;COMMENT_DATETIME&quot;, &quot;USER_ID&quot;) VALUES (:COMMENT_ID, :COMMENT_MESSAGE, :TASK_ID, :COMMENT_DATETIME, :USER_ID)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT &quot;COMMENT_ID&quot;, &quot;COMMENT_MESSAGE&quot;, &quot;TASK_ID&quot;, &quot;COMMENT_DATETIME&quot;, &quot;USER_ID&quot; FROM &quot;COMMENTS&quot;" UpdateCommand="UPDATE &quot;COMMENTS&quot; SET &quot;COMMENT_MESSAGE&quot; = :COMMENT_MESSAGE, &quot;TASK_ID&quot; = :TASK_ID, &quot;COMMENT_DATETIME&quot; = :COMMENT_DATETIME, &quot;USER_ID&quot; = :USER_ID WHERE &quot;COMMENT_ID&quot; = :COMMENT_ID">
            <DeleteParameters>
