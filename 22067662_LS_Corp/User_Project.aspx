...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="USER_PROJECT_ID" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True">
            <Columns>
        ...
        <asp:FormView ID="FormView1" runat="server" DataKeyNames="USER_PROJECT_ID" DataSourceID="SqlDataSource1">
            <InsertItemTemplate>
                ...
                <br />
                PROJECT_ID:
                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource3" DataTextField="PROJECT_NAME" DataValueField="PROJECT_ID">
                </asp:DropDownList>
                <br />
                USER_ID:
